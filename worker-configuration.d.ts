/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e2e2264f24fe7ff5e886828b167e145)
// Runtime types generated with workerd@1.20251217.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SEED_POOL: KVNamespace;
		RANDOM_ORG_API_KEY: string;
		RANDOM_ORG_HASHED_API_KEY: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RANDOM_ORG_API_KEY" | "RANDOM_ORG_HASHED_API_KEY">> {}
}
